...
public class RegisterTask extends AsyncTask<String, Void, Integer> {
	...
	private static String loginURL = "http://davegrounds.com/android_login_apitwo/";
	private static String registerURL = "http://davegrounds.com/android_login_apitwo/";
	...
	protected Integer doInBackground(String... arg0) {
		...
		EditText ageEdit = (EditText)activity.findViewById(R.id.editText1age);
        ...
        JSONObject json = userFunction.registerUser(name, age, email, password);
