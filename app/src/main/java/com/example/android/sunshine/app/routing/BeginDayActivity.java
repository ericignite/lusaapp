...
public class BeginDayActivity extends ActionBarActivity {

    private final String LOG_TAG = BeginDayActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.container, new BeginDayFragment())
                    .commit();
        }
    }
    ...
    public static class BeginDayFragment extends Fragment {
        Button btnLogin;
        Button btnLinkToRegister;
        TextView loginErrorMsg;
        private final String LOG_TAG = BeginDayFragment.class.getSimpleName();
        public BeginDayFragment() {
        }
        @Override
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.begin_day, container, false);
           ...
           drive_next_property_btn.setOnClickListener(new View.OnClickListener()
            {
                ...
                {
                    Log.d("Test", "onClickListener ist login_btn");
                    startActivity(new Intent(getActivity(), ChoosePropertyActivity.class));
